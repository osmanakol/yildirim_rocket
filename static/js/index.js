...
function projectScroll() {
    if (window.pageYOffset + 700 > projectSticky) {
        ...
        $(".pc1, .pc2, .pc3, .pc4, .pc5").css("opacity", "1").css("margin-top", "0")
    } else {
        $(".projectHead-c").css("left", "40%")
        $(".pc1, .pc2, .pc3, .pc4, .pc5").css("opacity", "0").css("margin-top", "100px")
    }
}
...
function rankingScroll() {
    if (window.pageYOffset + 700 > rankingSticky) {
        ...
        $(".rc1, .rc2, .rc3, .rc4, .rc5").css("opacity", "1").css("margin-top", "0")
    } else {
        $(".rankingHead-c").css("left", "40%")
        $(".rc1, .rc2, .rc3, .rc4, .rc5").css("opacity", "0").css("margin-top", "100px")
    }
}
...
function picturesScroll() {
    if (window.pageYOffset + 700 > picturesSticky) {
        ...
        $(".picc1, .picc2, .picc3, .picc4, .picc5").css("opacity", "1").css("margin-top", "0")
    } else {
        $(".picHead-c").css("left", "40%")
        $(".picc1, .picc2, .picc3, .picc4, .picc5").css("opacity", "0").css("margin-top", "100px")
    }
}
